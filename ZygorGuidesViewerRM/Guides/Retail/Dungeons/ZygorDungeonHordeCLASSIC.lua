...
Ask him _"What roles?"_
|tip Click through the dialogue.
collect Warlord Goretooth's Command##12563 |goto 5.80,47.53 |condition itemcount(12563) == 1 or haveq(4903) or completedq(4903)
step
use Warlord Goretooth's Command##12563
accept Warlord's Command##4903
step
...
Follow the path down |goto 48.55,51.47 < 15 |only if walking
...
Swim through the pipe |goto 51.41,39.40 < 10 |walk
Exit the pipe |goto 51.91,38.19 < 10 |walk
Run into the portal |goto 54.31,34.43
...
step
Follow the path |goto Hellfire Peninsula/0 48.72,48.33 < 15 |only if walking
Follow the path down |goto 48.55,51.497 < 15 |only if walking
Run into the portal |goto 47.60,53.5 < 10 |walk
|tip You will need the Shattered Halls Key to enter this dungeon.
...
Run up the stairs |goto Hellfire Peninsula/0 46.43,59.08 < 15 |only if walking
Follow the path |goto 47.30,55.65 < 15 |only if walking
Run into the portal |goto 45.97,51.86 |walk
...
step
Run into the portal |goto 48.92,35.54 < 15
...
Swim through the pipe |goto 51.41,39.40 < 10 |walk
Exit the pipe |goto 51.91,38.19 < 10 |walk
Run into the portal |goto 54.31,34.41 < 10 |walk
...
accept Lost in Action##9738 |goto 52.29,35.98
step
Run into the portal |goto 54.31,34.41 < 15 |walk
Enter The Underbog Dungeon |goto The Underbog/0 0.00,0.00 |c |noway |q 9738
...
Follow the Ancestral Spirit Wolf |goto 33.62,43.52
...
accept Capture the Weapons##10627 |goto 29.80,31.26
step
kill Morgroron##21500
|tip He looks like a winged demon with 4 legs who walks around this area.
|tip You may need help with this.
collect Morgroron's Glaive##30785 |q 10627/2 |goto 23.31,38.05
step
kill Makazradon##21501
|tip He looks like a winged demon with 4 legs who walks around this area.
|tip You may need help with this.
collect Makazradon's Glaive##30786 |q 10627/1 |goto 22.30,35.94
step
talk Grokom Deatheye##19333
turnin Capture the Weapons##10627 |goto 29.80,31.26
step
Watch the dialogue
talk Grokom Deatheye##19333
...
Run into the portal |goto 47.48,52.02 < 15 |walk
|tip You will need the Shattered Halls Key to enter this dungeon.
...
Enter the building |goto Terokkar Forest/0 39.64,70.98 < 20 |walk
|tip You need the Shadow Labyrinth Key to open the door.
Run into the portal |goto 39.63,73.60 < 15 |walk
...
step
Run into the portal |goto 50.28,33.32 < 15 |walk
...
accept Grand Master Rohok##10756 |goto 55.02,35.95
step
talk Rohok##16583
|tip Inside the building.
turnin Grand Master Rohok##10756 |goto 53.2,38.2
accept Rohok's Request##10757 |goto 53.2,38.2
...
talk Rohok##16583
|tip Inside the building.
turnin Rohok's Request##10757 |goto 53.2,38.2
accept Hotter than Hell##10758 |goto 53.2,38.2
step
...
talk Rohok##16583
|tip Inside the building.
turnin Hotter than Hell##10758 |goto 53.2,38.2
]])
...
author="support@zygorguides.com",
description="This guide will walk you through completing Ahn'kahet: The Old Kingdom Quests.",
condition_end=function() return completedq() end,
},[[
step
