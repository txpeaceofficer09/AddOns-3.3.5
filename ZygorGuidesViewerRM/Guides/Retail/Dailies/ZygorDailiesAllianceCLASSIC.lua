...
collect Moonrest Gardens Plans##35783 |q 12000/1 |goto 22.01,54.66
step
talk Image of Archmage Modera##26673
...
kill Goramosh##26349
|tip Inside the building.
collect The Scales of Goramosh##35801 |q 12004/2 |goto 19.51,58.12
step
label "Collect_Goramosh's_Strange_Device"
kill Goramosh##26349
|tip Inside the building.
collect Goramosh's Strange Device##36742 |goto 19.51,58.12 |q 12055 |future
step
...
Teleport to the Platform |goto 19.98,60.65 < 10 |c |noway |q 12060
step
Observe the Object on the Surge Needle |q 12060/1 |goto 19.79,59.81
|tip Walk to the center of the platform.
step
use the Surge Needle Teleporter##36747 |goto 19.79,59.81
Return to the Moonrest Gardens |goto 22.56,56.97 < 20 |noway |c |q 12060
step
talk Image of Archmage Modera##26673
...
collect Ley Line Focus Control Ring##36751 |q 12065 |goto 26.32,64.86
step
label "Collect_Captain_Malin's_Letter"
kill Captain Emmy Malin##26762
collect Captain Malin's Letter##36756 |goto 26.32,64.86 |q 12067 |future
step
use Captain Malin's Letter##36756
accept A Letter for Home##12067 |goto 26.32,64.86
step
use the Ley Line Focus Control Ring##36751
|tip Use it on the Ley Line Focus.
|tip It looks like a large glowing half-circle.
Retrieve the Ley Line Focus Information |q 12065/1 |goto 26.47,65.03
step
talk Image of Archmage Modera##26673
...
collect Ley Line Focus Amulet##36779 |goto 32.27,71.72 |q 12083
step
use the Ley Line Focus Control Amulet##36779
|tip Use it on the Ley Line Focus.
|tip It looks like a large glowing half-circle.
Retrieve the Ley Line Focus Information |q 12083/1 |goto 32.07,72.09
step
talk Image of Archmage Modera##26673
...
turnin Search Indu'le Village##12098 |goto 40.25,66.87
accept The End of the Line##12107 |goto 40.25,66.87
step
use the Ley Line Focus Control Talisman##36815
|tip Use it on the Ley Line Focus.
|tip It looks like a large glowing half-circle underwater.
Retrieve the Ley Line Focus Information |q 12107/1 |goto 39.90,66.99
step
Observe the Azure Dragonshrine |q 12107/2 |goto 53.04,66.37
step
talk Image of Archmage Modera##26673
turnin The End of the Line##12107 |goto 29.00,55.45
accept Gaining an Audience##12119 |goto 29.00,55.45
step
talk Tariolstrasz##26443
turnin Gaining an Audience##12119 |goto 57.91,54.17
accept Speak with your Ambassador##12766 |goto 57.91,54.17
step
talk Lauriel Trueblade##27803
|tip Inside the building.
turnin Speak with your Ambassador##12766 |goto 60.00,55.09
accept Report to the Ruby Dragonshrine##12460 |goto 60.00,55.09
step
talk Ceristrasz##27506
turnin Report to the Ruby Dragonshrine##12460 |goto 52.21,50.04
accept Heated Battle##12416 |goto 52.21,50.04
stickystart "Kill_Frigid_Geist_Attacker"
stickystart "Kill_Frigid_Ghoul_Attacker"
step
kill 1 Frigid Abomination Attacker |q 12416/3 |goto 49.27,50.87
...
kill 8 Frigid Geist Attacker |q 12416/2 |goto 49.27,50.87
...
kill 12 Frigid Ghoul Attacker |q 12416/1 |goto 49.27,50.87
|tip Enemies will attack in waves. |notinsticky
|tip Assist the NPCs in killing them. |notinsticky
|tip NPCs will move to different areas periodically. |notinsticky
You can also find them at: |notinsticky
...
step
talk Ceristrasz##27506
turnin Heated Battle##12416 |goto 52.21,50.04
accept Return to the Earth##12417 |goto 52.21,50.04
step
...
Return #6# Ruby Keepers to the Earth |q 12417/1 |goto 46.67,52.23
You can find more around:
[45.77,47.55]
[48.49,45.98]
step
talk Ceristrasz##27506
turnin Return to the Earth##12417 |goto 52.21,50.04
accept Through Fields of Flame##12418 |goto 52.21,50.04
step
kill 6 Frigid Necromancer |q 12418/1 |goto 48.33,48.01
...
step
talk Ceristrasz##27506
turnin Through Fields of Flame##12418 |goto 52.21,50.04
accept The Steward of Wyrmrest Temple##12768 |goto 52.21,50.04
step
talk Tariolstrasz##26443
...
|tip At the top of the temple.
turnin Informing the Queen##12123 |goto 59.84,54.65
...
turnin Defending Wyrmrest Temple##12372 |goto 59.24,54.32 |next "Accept_Daily_Coldarra_Quests" |only if completedq(13413)
step
talk Hira Snowdawn##
...
accept Convention at the Legerdemain##13101 |goto 40.25,66.13 |only if questpossible |or
accept Infused Mushroom Meatloaf##13100 |goto 40.25,66.13 |only if questpossible |or
accept Mustard Dogs!##13107 |goto 40.25,66.13 |only if questpossible |or
accept Sewer Stew##13102 |goto 40.25,66.13 |only if questpossible |or
Accept Today's Cooking Daily |complete false |goto 40.25,66.13 |or
|tip You will only be able to accept one quest each day.
step
...
collect 1 Aged Dalaran Limburger##43137 |q 13103 |goto 54.89,31.71
...
collect 6 Half Full Dalaran Wine Glass##43138 |q 13103 |goto 54.89,31.71
...
collect 1 Jug of Wine##43128 |q 13101/2 |goto 53.23,31.94
...
collect 4 Infused Mushroom##43100 |q 13100 |goto Dalaran/2 49.90,46.15
|only if haveq(13100) or completedq(13100)
step
cast Basic Campfire##818
|tip You will need a cooking fire to cook with.
...
|tip Inside the building.
turnin Cheese for Glowergold##13103 |goto 36.62,27.81
|only if haveq(13103) or completedq(13103)
step
Enter the building |goto 50.29,37.62 < 5 |walk
talk Arille Azuregaze##29049
|tip Inside the building.
turnin Convention at the Legerdemain##13101 |goto 48.39,37.46
|only if haveq(13101) or completedq(13101)
step
Enter the building |goto 48.99,56.99 < 5 |walk
talk Orton Bennet##29527
|tip Inside the building.
turnin Infused Mushroom Meatloaf##13100 |goto 52.33,55.59
|only if haveq(13100) or completedq(13100)
step
talk Archmage Pentarus##28160
turnin Mustard Dogs!##13107 |goto 68.54,41.99
|only if haveq(13107) or completedq(13107)
step
Enter the tunnel |goto 35.13,45.23 < 5 |walk
talk Ajay Green##29532
turnin Sewer Stew##13102 |goto Dalaran/2 35.44,57.62
|only if haveq(13102) or completedq(13102)
step
...
turnin Orfus of Kamagua##11573 |goto 40.29,60.25 |only if Alliance
